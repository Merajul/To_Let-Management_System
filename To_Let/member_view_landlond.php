<?php include './mheader.php';?>            
	...
	<?php 
	 $awlwxrSElect = mysqli_query($db,"SELECT * FROM member_wishlist WHERE member_id='$member' ORDER BY wishlist_id DESC");
      while($fetchData = mysqli_fetch_array($awlwxrSElect)){
      	$get_value = $fetchData['landloard_id'];
      	$SearchSelect = mysqli_query($db,"SELECT * FROM landload_reg WHERE reg_id='$get_value'");
	...
	<div class="listing-box-image" style="background-image: url('images/<?php echo $fetch_result['image'] ?>')">		
            <a href="member_details.php?Members=<?php echo $fetch_result['reg_id'] ?>" class="listing-box-image-link">
		</a>		
	...
	<div class="listing-box-content">
		<p>
			<?php echo $fetch_result['address']; ?><br>
