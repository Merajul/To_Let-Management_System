<?php include './header.php';?>
 <div class="main-wrapper">
	...
	<div class="content-title-inner">
		<div class="container">		
			<h1>Emerson Street 20921 Blvd.</h1>		
    ...
    <div class="listing-detail-attribute">
        <div class="key">Assigned Agent</div>
        <div class="value">
    ...
    <div class="listing-detail-attribute">
        <div class="key">Real Estate Agency</div>
        <div class="value">Villareal Real Estate </div>
    </div><!-- /.listing-detail-attribute -->                                             

    <div class="listing-detail-attribute">
        <div class="key">Location</div>
        <div class="value">New York / Brooklyn</div>
    </div><!-- /.listing-detail-attribute -->                                             
                            
    <div class="listing-detail-attribute">
        <div class="key">Price</div>
        <div class="value">$ 280.000,00</div>
    </div><!-- /.listing-detail-attribute -->
    ...
    <div class="gallery-item" style="background-image: url('assets/img/tmp/tmp-11.jpg');">
    </div><!-- /.gallery-item -->                

    <div class="gallery-item" style="background-image: url('assets/img/tmp/tmp-12.jpg');">
    </div><!-- /.gallery-item -->                

    <div class="gallery-item" style="background-image: url('assets/img/tmp/tmp-8.jpg');">
    </div><!-- /.gallery-item -->                
</div><!-- /.gallery -->
...
<div class="row">            
    <div class="col-lg-5">
        <div class="overview">
            ...
            <ul>
                <li><strong>Price</strong><span>$ 480 / per week</span></li>
                <li><strong>Location</strong><span>New York</span></li>
                <li><strong>Status</strong><span>Rent</span></li>
    ...
    <div class="col-lg-7">
        ...
        <p>
            Duis suscipit turpis suscipit lectus ultricies, placerat fermentum orci fringilla. Mauris semper magna cursus diam suscipit consectetur.
        </p>
...
<div class="valuation">
    <div class="valuation-item">
        <div class="valuation-item-key">
            Education
        </div><!-- /.valuation-item-key -->

        <div class="valuation-item-value">
            <span style="width: 86%">
                <strong>86%</strong>                            
            </span>
        </div><!-- /.valuation-item-value -->
    </div><!-- /.valuation-item -->
...
<div class="comment-create">
	<form method="post" action="http://villareal-html.wearecodevision.com/properties-detail-standard.html?">
    ...
    <ul class="nav nav-stacked nav-style-primary">
        ...
        <li class="nav-item">
            <a href="#" class="nav-link">
                <i class="fa fa-balance-scale"></i> Compare Property
            </a>
        </li><!-- /.nav-item -->
        ...
        <li class="nav-item">
            <a href="#" class="nav-link">
                <i class="fa fa-building"></i> View Agency Detail
            </a>
        </li><!-- /.nav-item -->
    ...
    <form method="post" action="http://villareal-html.wearecodevision.com/properties-detail-standard.html?">
        ...
        <div class="form-group-btn">
            ...
            <div class="widget">
    <h3 class="widgettitle">Assigned Agents</h3>

    
        <div class="listing-small">
	<div class="listing-small-inner">
		<div class="listing-small-image">
			<a href="agent-detail.html" style="background-image: url('assets/img/tmp/agent-1.jpg');">
			</a>
		</div><!-- /.listing-small-image -->

		<div class="listing-small-content">
			<h3><a href="agent-detail.html">Linda A. Libby</a></h3>
	...
	<div class="listing-small-inner">
		<div class="listing-small-image">
			<a href="agent-detail.html" style="background-image: url('assets/img/tmp/agent-2.jpg');">
			</a>
		</div><!-- /.listing-small-image -->

		<div class="listing-small-content">
			<h3><a href="agent-detail.html">Anita D. Smith</a></h3>
			<h4><a href="mailto:info@example.com">info@example.com</a></h4>
		</div><!-- /.listing-small-content -->
	</div><!-- /.listing-small-inner -->
</div><!-- /.listing-small -->
	...
	<div class="listing-small-inner">
		<div class="listing-small-image">
			<a href="agent-detail.html" style="background-image: url('assets/img/tmp/agent-3.jpg');">
			</a>
		</div><!-- /.listing-small-image -->

		<div class="listing-small-content">
			<h3><a href="agent-detail.html">Ida R. Lane</a></h3>
			<h4><a href="mailto:info@example.com">info@example.com</a></h4>
		</div><!-- /.listing-small-content -->
	</div><!-- /.listing-small-inner -->
</div><!-- /.listing-small -->
