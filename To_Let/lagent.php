<?php include './lsidebar.php';?>            
	...
	<?php 
	 $awlwxrSElect = mysqli_query($db,"SELECT * FROM member_wishlist WHERE landloard_id='$landlond' && status='1' ORDER BY wishlist_id DESC");
	...
	<div class="listing-box-content">
		...
		<?php 
		if($fetchData['member_id'] == $fetch_result['member_id']){	 ?>
	<a href="Clearence.php?details=<?php echo $fetch_result['member_id']; ?>"><span style="padding: 5px 10px; background: #3bc5b7;color: #fff;text-decoration: none;">Clearance</span></a>
